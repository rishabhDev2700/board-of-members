...
export default function ProjectCard() {
    return (
        <Card className="lg:w-72 rounded-xl lg:inline-block m-2 lg:m-4 hover:scale-105 duration-200 shadow-md shadow-black/10">
            ...
            <CardContent className="h-1/2 flex flex-col justify-evenly">
                ...
                <Button className="mt-4 self-end"><Link href="project/43242"><ChevronRight /></Link></Button>
            </CardContent>
        </Card>
    )
}
