...
export default function Page() {
    ...
    return (
        <main className='p-2'>
            ...
            <Card className="m-2 p-2 dark:bg-neutral-900 shadow-md shadow-black/20 lg:w-1/3 lg:mx-auto lg:mt-12">
                ...
                <CardContent className="mt-4 font-light w-full">
                    <form onSubmit={handleSubmit(postData)} className='lg:px-12'>
                        ...
                        <Input className="my-2" id="description" type="text" {...register("description",{required:true})} />
