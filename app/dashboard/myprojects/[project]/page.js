...
export default function Page() {
    ...
    return (
        ...
        <Card className="lg:w-3/5 p-1 lg:p-2 w-full">
            <CardTitle className="py-2 px-0 lg:p-2">Team</CardTitle>
            <CardContent className="p-1 lg:p-4">
                <ScrollArea className="h-[30vh] flex flex-wrap shadow-inner shadow-black/20 lg:p-2">
        ...
        <form className='lg:w-1/3 my-4' onSubmit={handleSubmit(findUser)}>
            <Label className="w-full" htmlFor="user-mail">Search User by Email</Label>
            <Input className="w-full" id="user-mail" type="text" {...register("email")} placeholder="Search Email" />
            <Button className="my-4 w-1/2 h-12" type="submit">Search</Button>
        </form>
